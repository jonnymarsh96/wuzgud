...
export default class Govt extends React.PureComponent {
  constructor(props){
    super(props);
    this.state={
      data:[
  ...
  render() {
        ...
        const contentFeild={
          ...
          const paper={
            ...
            const cyber={
              ...
              color:"#E0162B",
              textShadow:"2px 1.5px 1px #ffffff",
              letterSpacing:"5px",
    ...
    const storyContent={
      ...
      return (
        <div style={container} >
          <Helmet title="Govt" meta={[ { name: 'description', content: 'Description of Govt' }]}/>
            ...
            <div style={contentFeild}>
              <div>
                ...
                <div style={content}>
                  <Paper style={paper}>
                    <h1 style={cyber}>Government</h1>
                    <p style={paperBody}>
                      Look here for all the newsest news here in your local community government.
                    </p>
                  </Paper>
                </div>
